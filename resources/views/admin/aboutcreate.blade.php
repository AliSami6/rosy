                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="openingday" class="form-control" id="" placeholder="Enter Working Day" required="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="opentime">Working Time</label>
                                    <input type="text" name="opentime" class="form-control" id="" placeholder="Enter Working Time" required="">
                                </div>
