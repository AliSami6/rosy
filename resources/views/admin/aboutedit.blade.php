                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <img style="height: 30vh" src="{{url($about->workingimage)}}" class="mb-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <img style="height: 30vh" src="{{url($about->greatimage)}}" class="mb-2">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="openingday" class="form-control" value="{{$about->openingday}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="opentime">Working Time</label>
                                    <input type="text" name="opentime" class="form-control" value="{{$about->opentime}}">
                                </div>
